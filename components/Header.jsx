            ...
            <header className="px-3 py-[20px] sm:px-[77px] sm:pt-[42px] flex justify-between">
                ...
                <nav className={`w-1/2 min-w-[537px] max-w-[537px] md:block hidden`}>
                    <ul className="flex justify-between items-center">
                        <li className="relative text-center cursor-pointer after:content-[''] after:absolute after:bottom-[-6px] after:left-0 after:w-full after:h-[2px] after:bg-white">Home</li>
                        <li className="text-center cursor-pointer">Collection</li>
                        <li className="text-center cursor-pointer">About</li>
                        <li className="text-center cursor-pointer">Contact</li>
                    </ul>
